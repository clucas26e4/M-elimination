module Syntax.MGA-SR.M-Elim.Preproof where
  {- STDLIB -}
  ...
  UnfoldPreproof*Copy-LGen :
    (G : LHSeq) ->
    (T T' D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (G ∣ (union (copy T (suc n)) T' , D)) ->
    Preproof* (G ∣ (union (union (copy T n) T) T' , D))
  UnfoldPreproof*Copy-LGen G [] T' D zero p =
    p
  UnfoldPreproof*Copy-LGen G [] T' D (suc n) p =
    p
  UnfoldPreproof*Copy-LGen G (T ∷ (A , n1)) T' D zero p =
    Preproof*Cong
      p
      (cong₂
        ...
        (begin
          ...
          union [] T ∎)
        (sym a=a+0))
  UnfoldPreproof*Copy-LGen G (T ∷ (A , n1)) T' D (suc n) p =
    seq-exchange
      G
  ...
  UnfoldPreproof*Copy-L :
    (G : LHSeq) ->
    (T D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (G ∣ (copy T (suc n) , D)) ->
    Preproof* (G ∣ (union (copy T n) T , D))
  UnfoldPreproof*Copy-L G T D n = UnfoldPreproof*Copy-LGen G T [] D n



  UnfoldPreproof*Copy-RGen :
    (G : LHSeq) ->
    (T D D' : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (G ∣ (T , union (copy D (suc n)) D')) ->
    Preproof* (G ∣ (T , union (union (copy D n) D) D'))
  UnfoldPreproof*Copy-RGen G T [] D' zero p =
    p
  UnfoldPreproof*Copy-RGen G T [] D' (suc n) p =
    p
  UnfoldPreproof*Copy-RGen G T (D ∷ (A , n1)) D' zero p =
    Preproof*Cong
      p
      (cong₂
        ...
        (begin
          ...
          union [] D ∎)
        (sym a=a+0))
  UnfoldPreproof*Copy-RGen G T (D ∷ (A , n1)) D' (suc n) p =
    seq-exchange
      G
      T
      T
  ...
  UnfoldPreproof*Copy-R :
    (G : LHSeq) ->
    (T D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (G ∣ (T , copy D (suc n))) ->
    Preproof* (G ∣ (T , union (copy D n) D))
  UnfoldPreproof*Copy-R G T D n = UnfoldPreproof*Copy-RGen G T D [] n

  UnfoldPreproof*Copy-L-head-Gen :
    (T T' D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (head (union (copy T (suc n)) T' , D)) ->
    Preproof* (head (union (union (copy T n) T) T' , D))
  UnfoldPreproof*Copy-L-head-Gen [] T' D zero p =
    p
  UnfoldPreproof*Copy-L-head-Gen [] T' D (suc n) p =
    p
  UnfoldPreproof*Copy-L-head-Gen (T ∷ (A , n1)) T' D zero p =
    Preproof*Cong
      p
      (cong₂
        ...
        (begin
          ...
          union [] T ∎)
        (sym a=a+0))
  UnfoldPreproof*Copy-L-head-Gen (T ∷ (A , n1)) T' D (suc n) p =
    seq-exchange-head
      (union T' (union (copy T (suc n) ∷ (A , n1 + n * n1)) T) ∷ (A , n1))
      (union (union (copy T (suc n) ∷ (A , n1 + n * n1)) T ∷ (A , n1)) T')
      D
  ...
  UnfoldPreproof*Copy-L-head :
    (T D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (head (copy T (suc n) , D)) ->
    Preproof* (head (union (copy T n) T , D))
  UnfoldPreproof*Copy-L-head T D n = UnfoldPreproof*Copy-L-head-Gen T [] D n



  UnfoldPreproof*Copy-R-head-Gen :
    (T D D' : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (head (T , union (copy D (suc n)) D')) ->
    Preproof* (head (T , union (union (copy D n) D) D'))
  UnfoldPreproof*Copy-R-head-Gen T [] D' zero p =
    p
  UnfoldPreproof*Copy-R-head-Gen T [] D' (suc n) p =
    p
  UnfoldPreproof*Copy-R-head-Gen T (D ∷ (A , n1)) D' zero p =
    Preproof*Cong
      p
      (cong₂
        ...
        (begin
          ...
          union [] D ∎)
        (sym a=a+0))
  UnfoldPreproof*Copy-R-head-Gen T (D ∷ (A , n1)) D' (suc n) p =
    seq-exchange-head
      T
      T
      (union D' (union (copy D (suc n) ∷ (A , n1 + n * n1)) D) ∷ (A , n1))
  ...
  UnfoldPreproof*Copy-R-head :
    (T D : ListLTerm) ->
    (n : ℕ) ->
    Preproof* (head (T , copy D (suc n))) ->
    Preproof* (head (T , union (copy D n) D))
  UnfoldPreproof*Copy-R-head T D n = UnfoldPreproof*Copy-R-head-Gen T D [] n
  ...
  Preproof*CongKeepLeaves* :
    {G G' : LHSeq} ->
    (pG : Preproof* G) ->
    (G=G' : G ≡ G') ->
    (leaves* (Preproof*Cong pG G=G')) ≡ leaves* pG
  Preproof*CongKeepLeaves* pG refl = refl

  unionCopy-L*KeepLeaves* :
    {G : LHSeq} ->
    {T T' D : ListLTerm} ->
    {n n' : ℕ} ->
    (ppG : Preproof* (G ∣ (union T (copy T' (n + n')) , D))) ->
    leaves* (unionCopy-L* G T T' D n n' ppG) ≡ leaves* ppG
  unionCopy-L*KeepLeaves* {n = zero} {zero} ppG =
    refl
  unionCopy-L*KeepLeaves* {G} {T} {T'} {D} {n = zero} {suc n'} ppG =
    Preproof*CongKeepLeaves*
      ppG
      (cong
        (λ x -> G ∣ (union T x , D))
        (sym (union[]T=T (copy T' (suc n')))))
  unionCopy-L*KeepLeaves* {G} {T} {T'} {D} {n = suc n} {zero} ppG =
    Preproof*CongKeepLeaves*
      ppG
      (cong
        (λ x -> G ∣ (union T (copy T' (suc x)) , D))
        (sym a=a+0))
  unionCopy-L*KeepLeaves* {G} {T} {[]} {D} {suc n} {suc n'} ppG =
    refl
  unionCopy-L*KeepLeaves* {G} {T} {T' ∷ (A , nA)} {D} {suc n} {suc n'} ppG =
    trans
      (unionCopy-L*KeepLeaves* {G} {T ∷ (A , nA + n * nA + (nA + n' * nA))} {T'} {D} {suc n} {suc n'}
        (seq-exchange
          G
          (union T (copy T' (suc (n + (suc n')))) ∷ (A , nA + n * nA + (nA + n' * nA)))
          (union (T ∷ (A , nA + n * nA + (nA + n' * nA))) (copy T' (suc n + (suc n'))))
  ...
  unionCopy-R*KeepLeaves* :
    {G : LHSeq} ->
    {T D D' : ListLTerm} ->
    {n n' : ℕ} ->
    (ppG : Preproof* (G ∣ (T , union D (copy D' (n + n'))))) ->
    leaves* (unionCopy-R* G T D D' n n' ppG) ≡ leaves* ppG
  unionCopy-R*KeepLeaves* {n = zero} {zero} ppG =
    refl
  unionCopy-R*KeepLeaves* {G} {T} {D} {D'} {n = zero} {suc n'} ppG =
    Preproof*CongKeepLeaves*
      ppG
      (cong
        (λ x -> G ∣ (T , union D x))
        (sym (union[]T=T (copy D' (suc n')))))
  unionCopy-R*KeepLeaves* {G} {T} {D} {D'} {n = suc n} {zero} ppG =
    Preproof*CongKeepLeaves*
      ppG
      (cong
        (λ x -> G ∣ (T , union D (copy D' (suc x))))
        (sym a=a+0))
  unionCopy-R*KeepLeaves* {G} {T} {D} {[]} {suc n} {suc n'} ppG =
    refl
  unionCopy-R*KeepLeaves* {G} {T} {D} {D' ∷ (A , nA)} {suc n} {suc n'} ppG =
    trans
      (unionCopy-R*KeepLeaves*
        {G}
        {T}
