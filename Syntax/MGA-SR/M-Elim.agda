module Syntax.MGA-SR.M-Elim where
  {- STDLIB -}
  ...
  open import Syntax.MGA-SR.M-Elim.Step2 renaming (applyContraction to applyContraction* ; mElim to mElim* ; mElim-headGH to mElim-headGH*)
  open import Syntax.MGA-SR.M-ElimCan.Step2
  open import Syntax.MGA-SR.MGA-SRwM
  ...
  fromMGA-SR*toMGA-SR†* (hseq-exchange G G' x p) = 
    hseq-exchange G G' x (fromMGA-SR*toMGA-SR†* p)
  fromMGA-SR*toMGA-SR†* (M G T T' D D' refl refl p p') = 
    M*-rule
      G
      T
      T'
      D
      D'
      (fromMGA-SR*toMGA-SR†* p)
      (fromMGA-SR*toMGA-SR†* p')
  fromMGA-SR*toMGA-SR†* (M-head T T' D D' refl refl p p') =
    M-head*-rule
      T
      T'
      D
