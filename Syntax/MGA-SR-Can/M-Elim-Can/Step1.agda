module Syntax.MGA-SR-Can.M-Elim-Can.Step1 where
  {- STDLIB -}
  ...
  open import Syntax.MGA-SR-Can.M-Elim-Can.PumpingLemma
  open import Syntax.MGA-SR-Can.M-Elim-Can.InteractionProofPreproof
  open import Syntax.ListLTerm.Properties
  open import Syntax.LHSeq.Properties
  open import Syntax.MGA-SR-Can.Properties
...
--{{{
  ...
  step1 .(head (Γ , Δ)) H T D (can-rule-head Γ Δ A pG) pHTD (headMerging .Γ .Δ .T .D n) =
    can-rule
      H
      (union Γ (copy T n))
      (union Δ (copy D n))
      ...
      (seq-exchange
        ...
        (step1
          ...
          pG
          pHTD
          (headMerging (Γ ∷ A) (Δ ∷ A) T D n)))
  step1 .(G ∣ (Γ , Δ)) H T D (can-rule G Γ Δ A pG) pHTD (consMerging .G .Γ .Δ .T .D n m) = 
    can-rule
      (unionLHSeq H (merge G T D m))
      (union Γ (copy T n))
      (union Δ (copy D n))
...
--{{{
  ...
  step1-head .(head (Γ , Δ)) T D (can-rule-head Γ Δ A pG) pHTD (headMerging .Γ .Δ .T .D n) = 
    can-rule-head
      (union Γ (copy T n))
      (union Δ (copy D n))
      A
      (seq-exchange-head
        ...
        (step1-head
          ...
          pHTD
          (headMerging (Γ ∷ A) (Δ ∷ A) T D n)))
  step1-head .(G ∣ (Γ , Δ)) T D (can-rule G Γ Δ A pG) pHTD (consMerging .G .Γ .Δ .T .D n m) = 
    can-rule
      (merge G T D m)
      (union Γ (copy T n))
      (union Δ (copy D n))
...
--{{{
      ...
      (sym
        (begin
          leaves (unionCopy-L (unionLHSeq H (merge G T D m)) (union Γ1 Γ2) T (union (union Δ1 Δ2) (union (copy D n₁) (copy D n))) n₁ n (unionCopy-R (unionLHSeq H (merge G T D m)) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m))))
            ≡⟨ unionCopy-LKeepLeaves {unionLHSeq H (merge G T D m)} {union Γ1 Γ2} {T} {union (union Δ1 Δ2) (union (copy D n₁) (copy D n))} {n₁} {n} (unionCopy-R (unionLHSeq H (merge G T D m)) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m))) ⟩
          leaves (unionCopy-R (unionLHSeq H (merge G T D m)) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m)))
            ≡⟨ unionCopy-RKeepLeaves {unionLHSeq H (merge G T D m)} {union (union Γ1 Γ2) (copy T (n₁ + n))} {union Δ1 Δ2} {D} {n₁} {n} (step1 (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m)) ⟩
    ...
    (sym
      (begin
        leaves (unionCopy-L H (union Γ1 Γ2) T (union (union Δ1 Δ2) (union (copy D n₁) (copy D n))) n₁ n (unionCopy-R H (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (head (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (headMerging (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n)))))
          ≡⟨ unionCopy-LKeepLeaves {H} {union Γ1 Γ2} {T} {union (union Δ1 Δ2) (union (copy D n₁) (copy D n))} {n₁} {n} (unionCopy-R H (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (head (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (headMerging (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n)))) ⟩
        leaves (unionCopy-R H (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1 (head (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (headMerging (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n))))
          ≡⟨ unionCopy-RKeepLeaves {H} {union (union Γ1 Γ2) (copy T (n₁ + n))} {union Δ1 Δ2} {D} {n₁} {n} (step1 (head (union Γ1 Γ2 , union Δ1 Δ2)) H T D pG pHTD (headMerging (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n))) ⟩
  ...
  Propstep1 .(head (Γ , Δ ∷ (one , k))) H T D (1-rule-head Γ Δ k pG) pHTD n' ◆pG≤n (headMerging .Γ .(Δ ∷ (one , k)) T D n) =
    Propstep1
      ...
      ◆pG≤n
      (headMerging Γ Δ T D n)
  Propstep1 .(head (Γ , Δ)) H T D (can-rule-head Γ Δ A pG) pHTD n' ◆pG≤n (headMerging .Γ .Δ T D n) =
    Propstep1
      (head (Γ ∷ A , Δ ∷ A))
      H
      T
      ...
      ◆pG≤n
      (headMerging (Γ ∷ A) (Δ ∷ A) T D n)
  Propstep1 .(G ∣ (Γ , Δ)) H T D (can-rule G Γ Δ A pG) pHTD n' ◆pG≤n (consMerging .G .Γ .Δ T D n m) = 
    Propstep1
      (G ∣ (Γ ∷ A , Δ ∷ A))
      H
      T
...
--{{{
      ...
      (sym
        (begin
          leaves (unionCopy-L (merge G T D m) (union Γ1 Γ2) T (union (union Δ1 Δ2) (union (copy D n₁) (copy D n))) n₁ n (unionCopy-R (merge G T D m) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1-head (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m))))
            ≡⟨ unionCopy-LKeepLeaves {merge G T D m} {union Γ1 Γ2} {T} {union (union Δ1 Δ2) (union (copy D n₁) (copy D n))} {n₁} {n} (unionCopy-R (merge G T D m) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1-head (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m))) ⟩
          leaves (unionCopy-R (merge G T D m) (union (union Γ1 Γ2) (copy T (n₁ + n))) (union Δ1 Δ2) D n₁ n (step1-head (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m)))
            ≡⟨ unionCopy-RKeepLeaves {merge G T D m} {union (union Γ1 Γ2) (copy T (n₁ + n))} {union Δ1 Δ2} {D} {n₁} {n} (step1-head (G ∣ (union Γ1 Γ2 , union Δ1 Δ2)) T D pG pHTD (consMerging G (union Γ1 Γ2) (union Δ1 Δ2) T D (n₁ + n) m)) ⟩
  ...
  Propstep1-head .(head (Γ , Δ ∷ (one , k))) T D (1-rule-head Γ Δ k pG) pHTD n' ◆pG≤n (headMerging .Γ .(Δ ∷ (one , k)) T D n) =
    Propstep1-head
      ...
      ◆pG≤n
      (headMerging Γ Δ T D n)
  Propstep1-head .(head (Γ , Δ)) T D (can-rule-head Γ Δ A pG) pHTD n' ◆pG≤n (headMerging .Γ .Δ T D n) =
    Propstep1-head
      (head (Γ ∷ A , Δ ∷ A))
      T
      D
      ...
      ◆pG≤n
      (headMerging (Γ ∷ A) (Δ ∷ A) T D n)
  Propstep1-head .(G ∣ (Γ , Δ)) T D (can-rule G Γ Δ A pG) pHTD n' ◆pG≤n (consMerging .G .Γ .Δ T D n m) = 
    Propstep1-head
      (G ∣ (Γ ∷ A , Δ ∷ A))
      T
      D
...
--{{{
  ...
  Propstep1-head-bis .(head (Γ , Δ ∷ (one , k))) T D (1-rule-head Γ Δ k pG) pHTD (headMerging .Γ .(Δ ∷ (one , k)) T D n) =
    Propstep1-head-bis
      ...
      pHTD
      (headMerging Γ Δ T D n)
  Propstep1-head-bis .(head (Γ , Δ)) T D (can-rule-head Γ Δ A pG) pHTD (headMerging .Γ .Δ T D n) =
    Propstep1-head-bis
      (head (Γ ∷ A , Δ ∷ A))
      T
      D
      ...
      pHTD
      (headMerging (Γ ∷ A) (Δ ∷ A) T D n)
  Propstep1-head-bis .(G ∣ (Γ , Δ)) T D (can-rule G Γ Δ A pG) pHTD (consMerging .G .Γ .Δ T D n m) = 
    Propstep1-head-bis
      (G ∣ (Γ ∷ A , Δ ∷ A))
      T
      D
